...
fit <- stan(file='linearmodel.stan', data=dat,
            iter=2000, chains=4, seed=4938483,
            control = list(adapt_delta = 0.8))

paramnames<-c("alpha","beta_female","beta_treatment","beta_interaction")
```
...
The Stan model shows that one could argue that there is some weak evidence for testosterone going up when one holds a high power pose. There is a 95% probability of the treatment coefficient being positive. 
