...
One could do a two-sample t-test like this:
...
We could also have as dependent measure the change in testosterone in low vs high power subjects. This corresponds to the Fig 3 question.
...
So, in fact, both the t-test and the likelihood ratio test show that there is *no* evidence in the Cuddy data for power posing raising testosterone. Her Ted talk was based on a fictional claim.
